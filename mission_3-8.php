...
if (!isset($_SESSION["NAME"])) {
    header("Location: Logout_3-8.php");
    exit;
}
?>
...
$date = new DateTime();
$str = $num  . '<>' . $_POST['name'] . '<>' . $_POST['comment']. '<>' . $date ->format('Y-m-d-H-i-s') 
...
<FORM method="POST" enctype="multipart/form-data" action="mission_3-8.php">
...
<P>画像アップロード</P>
	画像パス：<INPUT type="file" name="attachment_file" size="30"><BR>
	<P>動画アップロード</P>
	動画パス：<INPUT type="file" name="upfile" size="30"><BR>
